...
private
  ...
  def get_idp_from_cookie
    ...
    if !last_status_value.nil? && !last_status['IDP'].nil?
      return retrieve_decorated_singleton_idp_array_by_entity_id(current_identity_providers_for_sign_in, last_status['IDP'])[0]
    end
  end
